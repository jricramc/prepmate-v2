  ...
  <div className='mx-auto text-gray-800 mt-4 grid grid-cols-1 md:grid-cols-12 gap-4 p-5 items-center'>
    ...
    <div className="py-5 px-4 mx-auto max-w-screen-xl sm:py-5 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
            ...
            <a href="https://app.prepmate.shop/" target= "_blank" className="relative inline-flex items-center gap-x-1.5 rounded-md bg-primary px-8 py-4 text-lg font-semibold text-white 
