...
import HomeMenu from '../components/layout/HomeRestaurants'
  ...
  <>
    ...
    <div className="py-5 px-4 mx-auto max-w-screen-xl sm:py-5 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
            ...
            <a href="#" className="relative inline-flex items-center gap-x-1.5 rounded-md bg-primary px-8 py-4 text-lg font-semibold text-white 
