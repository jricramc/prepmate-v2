const people = [
    {
      ...
      role: 'Co-Founder',
      description: "MIT '25",
      imageSource: '/team/harp.PNG', 
      xUrl: 'https://x.com/theharpsingh',
      linkedinUrl: 'https://www.linkedin.com/in/harp-singh128/',
    },
    {
        name: 'Jose Ricardo',
        role: 'Co-Founder',
      ...
      <div className="bg-white py-32">
        <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
          ...
          >
            {people.map((person) => (
              <li key={person.name}>
                <img className="mx-auto h-56 w-56 rounded-full" src={person.imageSource} alt="" />
                ...
                <ul role="list" className="mt-6 flex justify-center gap-x-6">
                  <li>
                    <a href={person.xUrl} className="text-gray-400 hover:text-gray-500" target="_blank" rel="noopener noreferrer">
