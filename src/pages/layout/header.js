                ...
                {/* <Disclosure>
                  {() => (
                    <>
                      ...
                      <Disclosure.Panel className="absolute right-0 w-64 mt-2 origin-top-right bg-white divide-y divide-gray-100 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none overflow-auto h-96">
                        <div className="px-1 py-1 ">
                          Your cart items go here
                        </div>
                        <div className="px-1 py-1 bg-gray-100 fixed bottom-0 w-full">
